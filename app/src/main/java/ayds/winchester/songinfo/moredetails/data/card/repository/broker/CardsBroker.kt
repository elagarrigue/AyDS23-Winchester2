...
import ayds.winchester.songinfo.moredetails.data.card.repository.proxy.CardProxy
...
internal class CardsBrokerImpl(private val proxiesList: List<CardProxy>): CardsBroker {
